...
import { WebsiteConfiguration, RoutingRule } from './WebsiteConfig';
...
export default class BucketInfo {
    ...
    */
    constructor(name, owner, ownerDisplayName, creationDate,
        ...
        this._websiteConfiguration = websiteConfiguration ?
            new WebsiteConfiguration(websiteConfiguration) : null;
        return this;
    }
    /**
    ...
    */
     ...
     * @return {WebsiteConfig} WebsiteConfig class instance
     */
     ...
     * @param {object} obj - configuration for bucket website
     * @return {BucketInfo} - bucket info instance
     */
    setWebsiteConfiguration(obj) {
        if (obj instanceof WebsiteConfiguration) {
            this._websiteConfiguration = obj;
        } else {
            this._websiteConfiguration = new WebsiteConfiguration(obj);
        }
        return this;
    }
    /**
